...
final class CameraViewController2: UIViewController {
    ...
    fileprivate let ip = getIP() //IPChecker.getIP()
    ...
    override func viewDidLoad() {
        ...
        self.cameraView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(CameraViewController2.tapOnCameraView)))
    }
...
extension CameraViewController2: GCDAsyncSocketDelegate {
